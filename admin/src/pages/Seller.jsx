...
const Sellers = ({ token }) => {
  ...
  return (
    <div className="p-6 sm:p-8 bg-gradient-to-br from-gray-100 via-gray-50 to-gray-200 min-h-screen">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {sellers.map((seller) => (
          <div
            key={seller._id}
            className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition duration-300 p-6 cursor-pointer flex flex-col justify-between border border-gray-100"
      ...
      {selectedSeller && (
        <div className="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm flex items-center justify-center z-50 px-4">
          <div className="bg-white rounded-3xl max-w-md w-full p-6 relative shadow-2xl animate-fadeIn">
            <button
            ...
            <p className="mb-2">
              <span className="font-medium">GST:</span> {selectedSeller.gst}
            </p>
            <p className="mb-2">
            ...
            <p className="mb-2">
              ...
              <span
                className={`px-2 py-1 rounded-full text-white ${
                  selectedSeller.isApproved ? "bg-green-500" : "bg-yellow-500"
                }`}
              >
